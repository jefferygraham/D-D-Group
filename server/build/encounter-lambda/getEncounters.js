...
exports.handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var Client, client, campaign, q, response, encounter, q, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                if (!((event.path.substring(event.path.lastIndexOf('/') + 1, event.path.length)) == 'encounters')) return [3 /*break*/, 3];
                campaign = event.path.substring((event.path.lastIndexOf('campaign/') + 9), event.path.lastIndexOf('/'));
                q = "select * from encounters where campaignid=" + campaign;
